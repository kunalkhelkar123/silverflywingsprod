...
export default function Home() {
  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column", backgroundColor: "#f8f9fa" }}>
      ...
      {/* Top Navbar */}
      <header style={{ backgroundColor: "#343a40", color: "white", padding: "16px" }}>
        <div
          style={{
            display: "flex",
          ...
          <ul style={{ listStyleType: "none", padding: 0, margin: 0 }}>
            <li
              ...
              style={{
                ...
                padding: "12px",
                cursor: "pointer",
                backgroundColor: !showAddPackage ? "#495057" : "transparent",
                borderRadius: "4px",
                marginBottom: "8px",
              }}
            >
            ...
            <li style={{ padding: "12px", cursor: "pointer", borderRadius: "4px", marginBottom: "8px" }}>
              Countries
            </li>
            <li style={{ padding: "12px", cursor: "pointer", borderRadius: "4px", marginBottom: "8px" }}>
              Payment Terms
        ...
        <main style={{ flex: 1, padding: "24px", boxSizing: "border-box" }}>
          {!showAddPackage && (
            <div style={{ display: "flex", justifyContent: "center" }}>
              ...
              >
                <h2 style={{ fontSize: "24px", fontWeight: "bold", color: "#343a40" }}>{propertycount}</h2>
                <p style={{ color: "#6c757d" }}>Total Package</p>
              </div>
            </div>
          )}
        </main>
